...
public class IsolatedService extends Service {
    ...
    public static class Controller extends com.example.android.apis.Base_Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mService1 = new ServiceInfo(this.getActivity(), IsolatedService.class, R.id.start1, R.id.stop1,
                    R.id.bind1, R.id.status1);
            mService2 = new ServiceInfo(this.getActivity(), IsolatedService2.class, R.id.start2, R.id.stop2,
