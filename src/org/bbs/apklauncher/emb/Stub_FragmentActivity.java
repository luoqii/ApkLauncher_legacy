...
import org.bbs.apklauncher.emb.gen.Host_FragmentActivity;
...
implements CallBack {
	...
	static final String TAG = Stub_FragmentActivity.class.getSimpleName();
	...
	public void processIntent(Intent intent) {
		...
		if (null != com) {
			...
			if (!TextUtils.isEmpty(c)) {
				...
				intent.setComponent(new ComponentName(mRealBaseContext.getPackageName(), Stub_FragmentActivity.class.getCanonicalName()));
				intent.putExtra(Stub_FragmentActivity.EXTRA_LIB_PATH, mLibPath);
